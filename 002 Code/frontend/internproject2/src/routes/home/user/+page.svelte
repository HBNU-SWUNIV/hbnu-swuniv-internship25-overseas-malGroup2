<script>
  ...
  // ✅ 선택 삭제 (기존 유지: 버튼은 숨겨서 사용자 화면에서는 노출되지 않음)
  ...
  <section class="content">
    ...
    <div class="board">
        ...
        {:else}
          {#each paginatedAssets as a}
            <li class="card">
              ...
              <div class="actions">
                <!-- 사용자 화면: 체크박스/에딧 숨김(CSS로 display:none 처리) -->
                <label class="chk">
      ...
      <div class="pager">
        ...
        <!-- 사용자 화면: 삭제 버튼 숨김(CSS로 display:none 처리) -->
        <button
          class="delete"
